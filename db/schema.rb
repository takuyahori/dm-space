...
ActiveRecord::Schema.define(version: 2021_11_19_125745) do
  ...
  create_table "cliants", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.text "diet_history", null: false
    t.string "reset_password_token"
    t.datetime "reset_password_sent_at"
    t.datetime "remember_created_at"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["email"], name: "index_cliants_on_email", unique: true
    t.index ["reset_password_token"], name: "index_cliants_on_reset_password_token", unique: true
  end
  ...
  create_table "comments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["cliant_id"], name: "index_comments_on_cliant_id"
  ...
  create_table "posts", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["cliant_id"], name: "index_posts_on_cliant_id"
  end
  ...
  add_foreign_key "comments", "cliants"
